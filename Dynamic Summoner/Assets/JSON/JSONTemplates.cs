		...
		if(touched.Add(obj)) {
			...
			foreach(FieldInfo fi in fieldinfo) {
				...
				if(val) {
					...
					else UnityEngine.Debug.LogWarning("Null for this non-null object, property " + fi.Name + " of class " + obj.GetType().Name + ". Object type is " + fi.FieldType.Name);
				}
			}
			//Properties
			...
			foreach(PropertyInfo pi in propertyInfo) {
				...
				if(val) {
					...
					else UnityEngine.Debug.LogWarning("Null for this non-null object, property " + pi.Name + " of class " + obj.GetType().Name + ". Object type is " + pi.PropertyType.Name);
				}
			}
			return result;
		}
